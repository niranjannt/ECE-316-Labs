...
HD_PWD='C:/Users/niran/Desktop/ECE316/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log gate.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source gate.tcl -notrace

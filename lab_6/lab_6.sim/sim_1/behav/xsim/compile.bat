...
REM
REM Generated by Vivado on Fri Nov 21 23:58:36 -0600 2025
...
echo "xvlog --incr --relax -prj Stopwatch_Timer_Top_TB_vlog.prj"
call xvlog  --incr --relax -prj Stopwatch_Timer_Top_TB_vlog.prj -log xvlog.log

...
HD_PWD='C:/Users/niran/Desktop/ECE316/lab_6/lab_6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Stopwatch_Timer_Top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Stopwatch_Timer_Top.tcl -notrace

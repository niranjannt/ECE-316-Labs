...
REM
REM Generated by Vivado on Fri Oct 24 15:54:23 -0500 2025
...
echo "xvlog --incr --relax -prj tb_time_mux_state_machine_vlog.prj"
call xvlog  --incr --relax -prj tb_time_mux_state_machine_vlog.prj -log xvlog.log

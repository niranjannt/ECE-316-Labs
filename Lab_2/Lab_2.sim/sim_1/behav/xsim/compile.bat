...
REM
REM Generated by Vivado on Thu Sep 25 17:56:33 -0500 2025
...
echo "xvlog --incr --relax -prj tb_fourtoonemux_vlog.prj"
call xvlog  --incr --relax -prj tb_fourtoonemux_vlog.prj -log xvlog.log

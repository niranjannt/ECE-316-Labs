...
HD_PWD='C:/Users/niran/Desktop/ECE316/Lab_2/Lab_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fourtoonemux.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fourtoonemux.tcl -notrace
